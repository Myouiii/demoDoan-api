  ...
  try {
    ...
    if (parseInt(page) === -1) {
      ...
      const result = await ProductModel.find({})
        .skip(nSkip) // Method skip() được dùng để xác định sẽ lấy document trong kết quả ở vị trí thứ bao nhiêu bằng cách bỏ qua các document trước đó.
